...
export const WhatsAppPairing: React.FC = () => {
  ...
  const handleGenerateCode = async (e: React.FormEvent) => {
    ...
    setError(null);
    try {
      const result = await apiClient.requestWhatsAppPairing(phoneNumber);
    ...
    <div className="max-w-2xl mx-auto space-y-8">
      ...
      <div className="p-8 rounded-2xl bg-zinc-900 border border-zinc-800 space-y-6">
        ...
        {!isConnected && <div className="space-y-6">
          {!pairingCode ? <form onSubmit={handleGenerateCode} className="space-y-4">
          ...
          </form> : <div className="text-center space-y-4 py-4">
